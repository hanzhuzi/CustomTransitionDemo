//
//  PushByLeftToRightAnimator.swift
...
class PushByLeftToRightAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        toView.frame = CGRect(x: -initalFrame.size.width * 0.35, y: 0, width: initalFrame.size.width, height: initalFrame.size.height)
        ...
        fromView.layer.shadowColor = UIColor.black.withAlphaComponent(0.25).cgColor
        ...
        fromView.layer.add(basicAnima, forKey: "shadowOpacityAnimation")
        
        UIView.animate(withDuration: duration, delay: 0, options: UIView.AnimationOptions.curveEaseInOut, animations: {
            fromView.frame = CGRect(x: initalFrame.size.width, y: 0, width: initalFrame.size.width, height: initalFrame.size.height)
